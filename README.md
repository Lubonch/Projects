...
[**Fibonacci Sequence**](https://github.com/Lubonch/Projects/tree/master/Numbers/FibToN) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Binary to Decimal and Back Converter**](https://github.com/Lubonch/Projects/tree/master/Numbers/BinDecConverter) – Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.
...
[**Credit Card Validator**](https://github.com/Lubonch/Projects/tree/master/Numbers/CardValid) – Takes in a credit card number from a common credit card vendor (Visa, MasterCard, American Express, Discoverer) and validates it to make sure that it is a valid number (look into how credit cards use a checksum).
